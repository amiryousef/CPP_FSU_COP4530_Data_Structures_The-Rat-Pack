/*
    ...
    File modified and submitted as part of COP 4530 Project 2 "Rat Pack"
    ...
    3. void Solve()
       ...
       Uses depth-first-search to find a solution to the internally represented
       maze problem.
...
namespace maze
{
  ...
  public:
    ...
    void Solve         ( fsu::List < unsigned int > & solution );
    void ShowMaze      ( std::ostream& os = std::cout ) const;
    void ShowMaze3D    ( std::ostream& os = std::cout ) const;
